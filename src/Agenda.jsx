...
const aoClicarNoDia = (dataStr, agente) => {
    ...
    fetch("https://api.sheetbest.com/sheets/f6d72757-6186-4c31-a811-3295c2e79eeb/tabs/Onboarding%20Maio")
      ...
      .then((data) => {
        const adaptado = data.map((item) => {
          let dataRaw = typeof item["DIA DA AULA ZERO"] === "string" ? item["DIA DA AULA ZERO"].trim() : "";
  ...
  const agentesFiltrados = agenteSelecionado === "Todos" ? todosAgentesOrdenados : [agenteSelecionado];
  const diaParaFiltrar = filtroDia === "Hoje" ? hojeBR : filtroDia === "Data" ? dataSelecionada : null;
          ...
          ? todosAgentesOrdenados.map((agente) => {
              ...
              return (
                <div key={agente} className="coluna-agente">
                  <img src={`/fotos/${agente}.jpg`} alt={agente} className="foto-agente" />
