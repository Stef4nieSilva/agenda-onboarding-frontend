...
export default function Dashboard() {
  ...
  useEffect(() => {
    fetch("https://api.sheetbest.com/sheets/5978cb41-10b0-460d-890f-809b6e1cb10c/tabs/Onboarding%20Julho")
      .then((res) => res.json())
      .then((data) => {
        ...
        <div className="metric-box destaque-final">
          <div className="faltam-destaque">
            Faltam para Bater a Meta: <span className="faltam-valor">
              {(96.5 - parseFloat(porcentagemResolvidosFiltrado)).toFixed(2)}%
            </span>
          </div>
        </div>
      </div>
